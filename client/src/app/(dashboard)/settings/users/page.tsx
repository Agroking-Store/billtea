...
function UserManagementContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setToast({ type: 'success', text: modalMode === 'create' ? 'Staff member added successfully!' : 'Staff profile updated successfully!' });
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setToast({ type: 'success', text: 'Staff status updated successfully!' });
      setIsModalOpen(false);
      fetchData();
    } catch(err: any) {
